import { getDefaultLocation, getLocations, ILocationConfig, IRestaurantConfig } from "./locations";
...
export interface IConfig {
    ...
    readonly restaurants: ReadonlyMap<string, ReadonlyArray<IRestaurantConfig>>;
}
...
export class Config implements IConfig {
    ...
    public readonly restaurants = new Map(
        getLocations().map(location => [location.displayName, location.restaurants] as const)
    );
}
