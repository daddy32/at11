...
export const MockData = {
  validHTML: {
    ...
    foodseason:
      "<div><h3 class=\"av-special-heading-tag\">piatok</h3>" +
      "<div></div><div></div><div><ul><li>" +
      "<div class=\"av-catalogue-title-container\">" +
      "<span class=\"av-catalogue-title\">Šošovicová polievka</span>" +
      "<span class=\"av-catalogue-price\">1,50</span></div></li>" +
      "<li><div class=\"av-catalogue-title-container\">" +
      "<span class=\"av-catalogue-title\">Kuracie prsia na prírodno</span>" +
      "<span class=\"av-catalogue-price\">5,90</span></div></li>" +
      "</ul></div></div>"
  },
  validMenuItems: [
